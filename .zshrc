...
alias DesktopBuild="cd ~/Desktop/BUILD_COURSE_FOLDER; cd build_course; bin/build_course --server http://localhost:2778 ~/Desktop/BUILD_COURSE_FOLDER --output-dir ../Build/Public --force --verbose; cd ..; bundle exec rake flash:qbuild; cd -"
