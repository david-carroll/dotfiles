...
alias DesktopBuild="r-t; cd build_course; bin/build_course --server http://localhost:2778 ~/Projects/Syncthing/Tech_Data_Course_Definition/TechData_comp_law_239_migrateXml --output-dir ../Build/Public --force --verbose; cd ..; bundle exec rake flash:qbuild; cd -"
